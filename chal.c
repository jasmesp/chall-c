...
void challenge_09(void) {
    /* Challenge 9: If statement
       Store 12 in a variable. If it is greater than 10, print YES; otherwise print NO.
       Required output:
       YES
    */
...
void challenge_11(void) {
    /* Challenge 11: For loop count
       Use a for loop to print the numbers 1 through 5 on one line exactly like this:
       1 2 3 4 5
    */
...
void challenge_19(void) {
    /* Challenge 19: C string length
       Store the string "banana" and, without hard-coding the answer, print its length exactly:
       6
    */
...
void challenge_20(void) {
    /* Challenge 20: Count vowels
       Store the string "Education" and count the vowels (a, e, i, o, u, case-insensitive).
       Print exactly:
       5
    */
...
void challenge_21(void) {
    /* Challenge 21: Uppercase conversion
       Store the string "codex" and convert it to uppercase without changing the printed text by hand.
       Print exactly:
       CODEX
    */
